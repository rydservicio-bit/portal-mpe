...
import type { OtdrDiagnosisSummary } from "@/lib/otdr/types";
...
interface Props {
  diagnosis: OtdrDiagnosisSummary;
}

const OtdrSummaryPanel = ({ diagnosis }: Props) => (
  <motion.div
  ...
  >
    <div className="flex items-center gap-2">
      ...
      <h2 className="font-heading text-base font-bold text-foreground">Resultado del análisis</h2>
    </div>
    ...
    <div className="grid gap-3 sm:grid-cols-2">
      ...
      <Field label="Confianza" value={diagnosis.confidence} className={confidenceColors[diagnosis.confidence]} />
    </div>
...
export default OtdrSummaryPanel;
